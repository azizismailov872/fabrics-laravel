...
return new class extends Migration
{
    ...
    {
        Schema::create('fabrics_imports', function (Blueprint $table) {
            $table->id();
        ...
        Schema::table('fabrics_imports', function (Blueprint $table) {
    ...
    {   
        Schema::table('fabrics_imports', function($table) {
            $table->dropForeign(['user_id']);
        });
        Schema::dropIfExists('fabrics_imports');
    }
};
